    ...
    <nav class="navbar">
        <div class="max-width">
            ...
            <ul class="menu">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-btn">Hi, <?php echo $_SESSION['username']; ?>!</a>
                    <div class="dropdown-content">
                        <a href="logout.php">Logout</a>
                        <a href="booking_user/tampil_booking.php">Booked</a>
                    </div>
                </li>
        ...
        <div class="max-width">
            ...
            <div class="card-best-container">
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                    <a href="deskripsi/deskripsi_trip.php?nama_paket_trip=<?php echo urlencode($row['nama_paket_trip']); ?>&currency=<?php echo $currency; ?>" class="card-best-link">
                        <div class="card-best">
                ...
                while ($row = mysqli_fetch_assoc($result)) { ?>
                    <div class="hotel-cards">
                        <div class="card">
                            ...
                            <a href="deskripsi/deskripsi_trip.php?nama_paket_trip=<?php echo urlencode($row['nama_paket_trip']); ?>">
