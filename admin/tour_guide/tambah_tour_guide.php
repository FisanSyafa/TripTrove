        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="simpan_tour_guide.php" method="POST">
                                <div class="mb-3">
                                    <label for="tour_guide_name" class="form-label">Tour Guide Name</label>
                                    <input type="text" class="form-control" id="tour_guide_name" name="tour_guide_name" required>
                                </div>
                                <div class="mb-3">
                                    <label for="tour_guide_address" class="form-label">Address</label>
                                    <input type="text" class="form-control" id="tour_guide_address" name="tour_guide_address" required>
                                </div>
                                <div class="mb-3">
                                    <label for="tour_guide_no_telp" class="form-label">Phone Number</label>
                                    <input type="text" class="form-control" id="tour_guide_no_telp" name="tour_guide_no_telp" required>
                                </div>
