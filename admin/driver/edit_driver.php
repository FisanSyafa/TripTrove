        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="aksi_edit_driver.php" method="POST">
                                <input type="hidden" name="driver_id" value="<?php echo $row['driver_id']; ?>">
                                <div class="mb-3">
                                    <label for="driver_name" class="form-label">Driver Name</label>
                                    <input type="text" class="form-control" id="driver_name" name="driver_name" value="<?php echo $row['driver_name']; ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="driver_address" class="form-label">Address</label>
                                    <input type="text" class="form-control" id="driver_address" name="driver_address" value="<?php echo $row['driver_address']; ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="driver_no_telp" class="form-label">Phone Number</label>
                                    <input type="text" class="form-control" id="driver_no_telp" name="driver_no_telp" value="<?php echo $row['driver_no_telp']; ?>" required>
                                </div>
