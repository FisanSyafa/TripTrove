...
<head>
    ...
    <title>Add Payment Method - TRIPTROVE</title>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="simpan_payment_method.php" method="post">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="payment_method_code" name="payment_method_code" required>
                                </div>
                                <div class="mb-3">
